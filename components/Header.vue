  ...
  <section class="header grid" style="--cols: 12">
    ...
    <template v-else>
      ...
      <section class="item authorization" style="--span: 4">
        <a href="" @click.prevent="" class="btn sign-in default">
          <Icon name="user" props="left icon__header"/>
          Войти</a>
        <a href="" @click.prevent="" class="btn sign-out success">Зарегестрироваться <Icon name="arrow" props="right icon__header"/></a>
      </section>
    </template>
